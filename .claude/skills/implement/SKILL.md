---
name: implement
description: Implement one approved task from a feature spec and run the strongest available automated tests in scope. Use after sanity-check and before review-loop.
